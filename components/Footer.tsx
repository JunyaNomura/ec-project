...
const Footer: FC = () => {
  return (
    <footer className="p-4 bg-gray:400 sm:p-6 dark:bg-gray-900">
      <div className="md:flex md:justify-between">

        <div className="mb-6 md:mb-0">
          <a href="https://flowbite.com/" className="flex items-center">
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Canvas</span>
          </a>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 mt-10">
          ...
          <div>
            <ul className="text-gray-600 dark:text-gray-400">
              ...
              <li>
                <a href="" className="hover:underline">Recruit</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-gray-200 my-8">
          
        </div>


      <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">Canvas</a> All Rights Reserved.
      </span>
    </footer>
  )
}
